...
# Source: https://stackoverflow.com/questions/38197449/matlab-data-file-to-pandas-dataframe
import numpy as np
import time
...
def import_mats(fname):
    #mat = eng.load(fname, nargout=1) # loads files but cannot be open as python dict
    mat = hdf5storage.loadmat(fname)
    #mat = sio.loadmat(fname) # NotImplementedError: Please use HDF reader for matlab v7.3 files
    pass
    try:
        #mat = sio.loadmat(fname)
        mat = eng.load(fname, nargout=1)
    except:
        print("Failed again.")
        pass
